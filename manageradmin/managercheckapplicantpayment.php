			...
			?>
                            ...
                            <style>
								* {
								...
								<h3 style="color:Black;margin-top:20px;text-align:center;">Job Application</h3><br>
								...
								?>
								  <div class="column">
								    <div class="card">
								      ...
								      <a href="managercheckpayment.php?JobID=<?php echo $r['PaymentID'];?>" class="button">CHECK</a>
								    </div>
								  </div>
								<?php
								    }
