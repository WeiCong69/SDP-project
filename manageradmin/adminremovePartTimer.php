...
$query = "select * from rating as a inner join `part-timer` as b on a.`Part-timerID`=b.`Part-timerID` where b.status <>'Suspended' group by a.`Part-timerID` HAVING AVG(a.Rating_Score) <3";

$query2="SELECT * from `part-timer` as a inner join rating as b on a.`Part-timerID`=b.`Part-timerID` where status='suspended'";
...
<body class="materialdesign">
    ...
    <div class="wrapper-pro">
		...
		<div class="container-fluid">
			...
			<table class="table">
    			<br><br><h3 align="center">Applicant</h3><br><br> 				
			  <thead>
			    <tr>
			...
			echo'
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td scope="row">'.$r['Rating_Score'].'</td>
			      <td scope="row"> <input class="btn btn-danger" type="button" value="Suspend" onclick="window.location.href=\'adminRemove.php?ID='.$r['Part-timerID'].'\'"></td>
				 </td>
			    </tr>
		...
		<table class="table">
    			<br><br><h3 align="center">Suspended Applicant</h3><br><br> 				
			  <thead>
			    <tr>
			      <th scope="col">Name</th>
			      <th scope="col">Full Name</th>			      
			...
			echo'
			  ...
			  <tbody>
			    <tr>
			      <td scope="row">'.$r2['FullName'].'</td>
			      <td scope="row">'.$r2['Username'].'</td>
			      <td scope="row">'.$r2['Rating_Score'].'</td>
			      <td scope="row"> <input class="btn btn-success" type="button" value="Unblock" onclick="window.location.href=\'adminUnblock.php?ID='.$r2['Part-timerID'].'\'"></td>
				 </td>
			    </tr>
