...
<!-- View Job Post start-->
										...
										<div class="text-center">
											<h3 style="font-size:40px">Job Applicants</h3>
										</div><br>
														<?php
														include("connection.php");
														$id = intval($_GET['JobID']);
														$query = "SELECT * from applicationid inner join `Part-timer` on applicationid.`Part-timerID`=`Part-timer`.`Part-timerID` where JobID='$id'";
