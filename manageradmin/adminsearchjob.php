        ...
        <div class="content-inner-all">
			...
			?>
                                    ...
                                    <div class="container">
                                        ...
                                        <br><br>
                                      <form action="ViewJob.php" class="search-job" method="POST">
									...
									<div class="container">
											<table class ="table table-striped" width="150%">
                                                ...
                                                <td scope="col">Check Applicant</td>
                                                <td scope="col">Edit Job</td>
                                            ...
                                            <?php
                                                ...
                                                while($r=mysqli_fetch_assoc($result)){
                                                    ...
                                                    echo $r['Username'];
                                                    echo "</td>";
                                                    echo "<td><a href=\"managercheckapplicant.php?JobID=";
                                                    echo $r['JobID'];
                                                    echo "\">Check Applicant</a></td>";
                                                    echo "</td>";   
                                                    echo "<td><a href=\"EditJob.php?JobID=";
                                                    echo $r['JobID'];
                                                    echo "\">Edit Job</a></td>";
