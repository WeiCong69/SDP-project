...
$mysqli = new mysqli('localhost', 'root', '', 'huatgroup');
...
if($page=='view'){
	...
	$result= $mysqli->query("SELECT * FROM applicationid WHERE jobID='1'");
	while($r=$result->fetch_assoc()){
?>
	<tr>
		<td><?php echo $row['JobID'];?></td>
		<td><?php echo $row['Part-timerID'];?></td>
		<td><?php echo $row['Applicaton'];?></td>
	</tr>
<?php 
}else{
