...
<html lang="en">
 ...
 <div class="about-author d-flex p-4 bg-light">
              ...
              <div class="desc">
                <h3>What kind of job is provided for</h3>
                <p>forum by the questioner, user can only view te question at here, to have answer and comment user will have to press see more.</p>                
              </div>
            </div>
              ...
              <ul class="comment-list">
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>John Doe</h3>
                    <div class="meta">October 03, 2019 </div>
                    <p>hi</p>
