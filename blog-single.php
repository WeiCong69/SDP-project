      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 ftco-animate">
            ...
            <p>The company that provides a </p>
            
            <h2 class="mb-3 mt-5">#2. Meeting room</h2>
                       <p>
              <img src="images/2.2.jpg" alt="" class="img-fluid">
            </p>
            <p>Quisquam esse aliquam </p>
                        
             <h2 class="mb-3 mt-5">#3. Outdoor Meeting room</h2>
                       <p>
              <img src="images/3.jpg" alt="" class="img-fluid">
            </p>
            <p>Quisquam esse aliquam fuga distinctio, </p>

 				<h2 class="mb-3 mt-5">#4. Cafeteria</h2>
                       <p>
