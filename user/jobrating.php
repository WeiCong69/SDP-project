...
$result = mysqli_query ($con, "Select * From ((rating INNER JOIN job ON rating.JobID = job.JobID) INNER JOIN `part-timer` on rating.`Part-TimerID` = `part-timer`.`Part-TimerID`)WHERE `part-timer`.Username='$user'");
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><a href="dashboard.php"><strong>Applied Job</strong></a> <span class="bread-slash"></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1><span class="table-project-n">Rating</span>Table</h1>
                                     </div>
                                </div>
                                <div class="sparkline13-graph">
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="false" data-show-columns="true" data-show-pagination-switch="false" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar">
                                           <thead>
                                                <tr>
                                                    <th data-field="state" data-checkbox="true"></th>
                                                    <th data-field="id">JobID</th>
                                            ...
                                            <tbody>
                                                 <tr>
                                                    ...
                                                    <td><span class="heading">Rating :</span>
