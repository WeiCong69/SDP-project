            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-briefcase"></i> <span class="mini-dn">Job</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="findjob.php" class="dropdown-item">Find Job</a>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                    <div class="inbox-email-menu-list shadow-reset">
                                            ...
                                            <li class="active"><a data-toggle="tab" href="#inbox"><span class="inbox-icon"><i class="fa fa fa-inbox "></i></span> Inbox <span></span></a>
                                            </li>
                                            <li><a href="viewmail.php" data-toggle="tab"><span class="inbox-icon"><i class="fa fa fa-inbox "></i></span> View Mail</a>
                                            </li>
                                            <li><a href="trash.php"><span class="inbox-icon"><i class="fa fa fa-trash-o "></i></span>Trash</a>
                                            </li>
                                         	</ul>
                                    </div>
                                </div>
                                <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
                                    <div class="tab-content view-mail-ov-mg-t-30">
                                                ...
                                                <table id="table1" data-toggle="table" data-pagination="true" data-search="false" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="false" data-click-to-select="true" data-toolbar="#toolbar1">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-field="company">View Details</th>
                                                    ...
                                                    <tbody>
                                                        <tr class="new-email">
                                                            ...
                                                            <td><a href="viewmail.php">View Details</a>
                                                            </td>
                                                            <td>10.00 pm</td>
                                                        </tr>
                                                        <tr class="new-email">
                                                            ...
                                                            <td><a href="viewmail.php">View Details</a></td>
                                                            <td>11.00 pm</td>
                                                        </tr>
                                                        <tr class="new-email">
                                                            <td></td>
                                        ...
                                        <div id="view" class="tab-pane fade in animated zoomInDown shadow-reset custom-inbox-message">
                                            <div class="view-mail-wrap">
                                                ...
                                                <div class="view-mail-content">
                                                    ...
                                                    <p>  sheets containing <span class="view-bdl">Lorem Ipsum passages</span>, and more recently with de of into <a class="view-mail-click" href="#">electronic typesetting</a>, remaining essentially unchanged.</p>
